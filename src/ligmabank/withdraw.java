...
public class withdraw extends javax.swing.JFrame {
 ...
 String username;
    ...
    private void withdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawActionPerformed
        // TODO add your handling code here:
      String amountStr = withdrawAmount.getText().trim();

    if (amountStr.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Enter withdraw amount!");
        return;
    }
    ...
    try {
        ...
        String checkSql = "SELECT balance FROM register WHERE username = ?";
        ...
        if (rs.next()) {
            ...
            // 2️⃣ Update balance
            String updateSql = "UPDATE register SET balance = balance - ? WHERE username = ?";
            ...
            // 3️⃣ Log transaction
           String insertTransactionSql = "INSERT INTO transactions(type, amount, date, username, location) VALUES (?, ?, CURRENT_TIMESTAMP, ?, ?)";
java.sql.PreparedStatement pstTrans = con.prepareStatement(insertTransactionSql);
pstTrans.setString(1, "Withdraw");
pstTrans.setDouble(2, amount);
pstTrans.setString(3, username);
pstTrans.setString(4, withdrawLocation.getSelectedItem().toString());
...
pstTrans.close();
    ...
    java.awt.EventQueue.invokeLater(() -> new withdraw(username).setVisible(true));
