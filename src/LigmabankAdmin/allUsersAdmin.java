 ...
 * @author Alejandro
 */
public class allUsersAdmin extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(allUsersAdmin.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Accura-Black", 0, 48)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(179, 202, 179));
        jLabel6.setText("Account Lookup");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new allUsersAdmin().setVisible(true));
    }
