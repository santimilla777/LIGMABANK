 ...
 * @author Alejandro
 */
public class updatebalAdmin extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(updatebalAdmin.class.getName());

    /**
     * Creates new form homeAdmin
     */
    public updatebalAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Update Account Balance");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new updatebalAdmin().setVisible(true));
    }
