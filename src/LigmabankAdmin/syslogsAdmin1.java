 ...
 * @author Alejandro
 */
public class syslogsAdmin1 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(syslogsAdmin1.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new syslogsAdmin1().setVisible(true));
    }
